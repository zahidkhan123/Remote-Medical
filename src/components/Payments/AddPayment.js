...
const AddPayment = (props) => {
    ...
    const categorySuccessfullyAdded = () => toast.success("Payment Successfully Added");
				...
				<div className="header-inner mb-5">
					<div>
						...
						<div className="bc-list">
							<Link to={{pathname: `/dashboard`}}>Dashboard</Link>/ <Link to={{pathname: `/payments`}}>Payments</Link>/ {name}
						</div>
					</div>
				</div>
						...
						<div className="card-body">
							<form onSubmit={submitHandler}>
								...
								<div className="form-group form-check">
									...
									<button type="submit" className="btn btn-primary submit_button">Add Payment</button>
								</div>
							</form>
						</div>
					</div>
